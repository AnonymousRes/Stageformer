...
parser.add_argument('--data', type=str, help='Path to the data of decompensation task',
                    default='/home/leew/mimic3processed/decompensation/')
...
pickle_file = open('/home/leew/ehrits_data/dp/dp_mimic3_train_data.pkl', 'wb')
pickle.dump(train_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/leew/ehrits_data/dp/dp_mimic3_val_data.pkl', 'wb')
pickle.dump(val_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/leew/ehrits_data/dp/dp_mimic3_test_data.pkl', 'wb')
