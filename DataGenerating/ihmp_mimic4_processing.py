...
parser.add_argument('--data', type=str, help='Path to the data of in-hospital mortality task',
                    default='/home/leew/mimic4processed/in-hospital-mortality/')
...
pickle_file = open('/home/leew/ehrits_data/ihmp/ihmp_mimic4_train_data.pkl', 'wb')
pickle.dump(train_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/leew/ehrits_data/ihmp/ihmp_mimic4_val_data.pkl', 'wb')
pickle.dump(val_dict, pickle_file)
pickle_file.close()

pickle_file = open('/home/leew/ehrits_data/ihmp/ihmp_mimic4_test_data.pkl', 'wb')
