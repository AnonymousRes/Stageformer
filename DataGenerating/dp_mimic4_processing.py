...
parser.add_argument('--data', type=str, help='Path to the data of decompensation task',
                    default='~/mimic4processed/decompensation/')
...
pickle_file = open('~/dp_mimic4_train_data.pkl', 'wb')
pickle.dump(train_dict, pickle_file, protocol=4)
pickle_file.close()

pickle_file = open('~/dp_mimic4_val_data.pkl', 'wb')
pickle.dump(val_dict, pickle_file, protocol=4)
pickle_file.close()

pickle_file = open('~/dp_mimic4_test_data.pkl', 'wb')
