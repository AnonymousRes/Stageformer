...
from OurModel import StageEncoder
...
if __name__ == '__main__':
    ...
    baseline_dict = {
        'OurModel': StageEncoder,
    }
    baseline_names = ["OurModel"]
    ...
    logging_file = f'/home/user/projects/user_ehrits/out_log/dp_mimic{args.mimic_dataset:d}_ourmodel_results_log.log'
    ...
    for baseline_name in baseline_names:
        ...
        if args.mimic_dataset == 3:
            train_data_file = '/home/user/ehrits_data/dp/dp_mimic3_train_data.pkl'
            val_data_file = '/home/user/ehrits_data/dp/dp_mimic3_val_data.pkl'
            test_data_file = '/home/user/ehrits_data/dp/dp_mimic3_test_data.pkl'
            saved_model_file = f'/home/user/ehrits_data/dp/{baseline_name:s}-MIMIC-III'

            os.environ["CUDA_VISIBLE_DEVICES"] = '0'
        else:
            train_data_file = '/home/user/ehrits_data/dp/dp_mimic4_train_data.pkl'
            val_data_file = '/home/user/ehrits_data/dp/dp_mimic4_val_data.pkl'
            test_data_file = '/home/user/ehrits_data/dp/dp_mimic4_test_data.pkl'
            saved_model_file = f'/home/user/ehrits_data/dp/{baseline_name:s}-MIMIC-IV'
    ...
    pd.DataFrame(
        ...
        index=None).to_csv(f'/home/user/projects/user_ehrits/out_log/dp_mimic{args.mimic_dataset:d}_ourmodel_results.csv', index=None)
